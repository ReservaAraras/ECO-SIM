...
- Differentiation Focus: Carrying Capacity (Population Control) emphasizing grazing pressure footprints.
- Indicator species: Cutia (Dasyprocta azarae).
...
def main():
    ...
    save_svg(svg_content, 'notebook_23_1')
