...
# MODULE 33-1: Enhanced MIF - Fire Spread Dynamics
# ===================================================================================================
"""
Module documentation.
Notebook Differentiation:
- Differentiation Focus: Enhanced MIF - Fire Spread Dynamics emphasising wind-driven ignition, species flee responses, and post-fire succession.
- Indicator species: Canela-de-ema (Vellozia squamata).
...
class EcosystemRenderer:
    ...
    def generate_svg(self) -> str:
        ...
        # Title
        svg.append(f'<text x="20" y="30" font-size="15" fill="#ffffff" font-weight="bold">ECO-SIM: Enhanced MIF &#x2014; Fire Spread Dynamics</text>')
        svg.append(f'<text font-weight="bold" x="20" y="50" font-size="15" fill="#b0bec5">Wind-driven ignition · Species flee response · Post-fire succession</text>')
        ...
        svg.append(f'<g transform="translate({w-cw-20},340)">'
                   f'<rect width="{cw}" height="{ch}" fill="#1a1a2e" rx="8" ry="8" stroke="#ff7043" stroke-width="1" opacity="0.95"/>'
                   f'<text x="15" y="25" fill="#ff8a65" font-size="15" font-weight="bold">Feature: Enhanced MIF Fire Spread</text>'
                   f'<text font-weight="bold" x="15" y="48" fill="#cccccc" font-size="15">Fire ignites at frame {self.cfg.fire_start_frame} and spreads via</text>'
                   f'<text font-weight="bold" x="15" y="68" fill="#cccccc" font-size="15">stochastic neighbour propagation each 2nd tick.</text>'
                   f'<text font-weight="bold" x="15" y="88" fill="#cccccc" font-size="15">All surface species within flee radius panic-flee,</text>'
                   f'<text font-weight="bold" x="15" y="108" fill="#cccccc" font-size="15">triggering alarm cascades across the habitat.</text>'
                   f'<text font-weight="bold" x="15" y="128" fill="#cccccc" font-size="15">Fencing still corrals Nelore cattle; aerial species</text>'
                   f'<text font-weight="bold" x="15" y="148" fill="#cccccc" font-size="15">cross freely. MIF = integrated fire management.</text>'
                   f'</g>')
...
def main():
    ...
    print(f"Initializing Enhanced MIF Fire Spread Dynamics simulator on {CONFIG.device}...")
