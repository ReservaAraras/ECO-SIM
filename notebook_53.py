...
- Differentiation Focus: Resilience Test (Fire + Drought shock, then measure recovery) - 720 frames emphasizing light pollution halos.
- Indicator species: Escorpiao-amarelo (Tityus serrulatus).
...
def main():
    ...
    display(HTML(svg)); save_svg(svg, 'notebook_53')
