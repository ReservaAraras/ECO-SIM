...
- Differentiation Focus: Zoning Policy (Preservation, Sustainable Use, Buffer zones) - 710 frames emphasizing pathogen exposure gradients.
- Indicator species: Aranha-caranguejeira (Grammostola sp.).
...
def main():
    ...
    display(HTML(svg)); save_svg(svg, 'notebook_52.1')
